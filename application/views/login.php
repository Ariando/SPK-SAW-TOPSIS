...
<head>
    ...
    <title>Sistem Pendukung Keputusan Metode SAW WP TOPSIS</title>
...
<body class="bg-gradient-dark">
    <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        <div class="container">
            <a class="navbar-brand text-dark" style="font-weight: 900;" href="<?= base_url('') ?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Perbandingan Multi-Attribute Decision Making</a>
        </div>
    </nav>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 mt-0">
                <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                    <div class="text-center card-body p-0">
                        <img src="<?= base_url('assets/') ?>img/logo-akprind.png" class="mb-5" width="240px" height="auto">


                        <h3 style="font-weight: 800;">PERBANDINGAN METODE MULTI-ATTRIBUTE DECISION MAKING UNTUK SELEKSI KELAYAKAN PROPOSAL SKRIPSI</h3>
